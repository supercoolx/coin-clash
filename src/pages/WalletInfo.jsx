          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex justify-between">
                ...
                <div className="font-semibold"><span className="text-primary">{getPercent(token.tokenInfo.solAmount, token.tokenInfo.soldTokenAmount, token.tokenAmount, token.solAmount)}%</span></div>
              </div>
            </div>
          </div>
        </Link>)
