    ...
    <div className="container px-4 pb-24 mx-auto">
      ...
      <div className="mt-20">
        ...
        <div className="grid grid-cols-1 gap-3 mt-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {new Array(10).fill(0).map((_, key) => <Link to="/trade/7NY1Hn4AFZzub2wTTkwt7iFWcNepRrUMPVVLgKcnMbMB" key={key} className="p-3 pr-6 transition-all duration-200 cursor-pointer bg-dark-gray rounded-3xl hover:bg-slate-700">
